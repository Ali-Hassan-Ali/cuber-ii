@extends('cms.parent')
@section('title','INTERNATIONAL CYBERSECURITY create')
@section('page-big-title','INTERNATIONAL CYBERSECURITY')
@section('page-main-title','INTERNATIONAL CYBERSECURITY')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">INTERNATIONAL CYBERSECURITY Create</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="create-form">
...
<script>
    ...
    let formData = new FormData();
        ...
        store('/admin/internationals', formData),'/admin/internationals/create';
